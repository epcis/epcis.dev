            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                ...
                <div className="text-base">
                  <div className="font-semibold text-white">Tom Bianculli</div>
                  <div className="mt-1 text-gray-400">CTO of Zebra Technologies</div>
                </div>
              </figcaption>
            </figure>
          </div>
          <div className="flex flex-col border-t border-white/10 pt-10 sm:pt-16 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-8 xl:pl-20">
            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                ...
                />
                <div className="text-base">
                  <div className="font-semibold text-white">Nathan Clevenger</div>
                  <div className="mt-1 text-gray-400">CTO of Drivly</div>
                </div>
              </figcaption>
            </figure>
          </div>
